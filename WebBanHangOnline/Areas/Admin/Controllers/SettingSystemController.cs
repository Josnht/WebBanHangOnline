    ...
    public class SettingSystemController : Controller
    {
        ...
        public ActionResult AddSetting(SettingSystemViewModel req)
        {
            ...
            if (checkTitle == null)
            {
                ...
                ((SystemSetting)null).SettingKey = "SettingTitle";
                ((SystemSetting)null).SettingValue = req.SettingTitle;
                db.SystemSettings.Add(null);
            }
            else
            {
            ...
            {
                 set = new SystemSetting();
                ((SystemSetting)null).SettingKey = "SettingLogo";
                ((SystemSetting)null).SettingValue = req.SettingLogo;
                db.SystemSettings.Add(null);
            }
            else
            {
            ...
            {
                set = new SystemSetting();
                ((SystemSetting)null).SettingKey = "SettingEmail";
                ((SystemSetting)null).SettingValue = req.SettingEmail;
                db.SystemSettings.Add(null);
            }
            else
            {
            ...
            {
                set = new SystemSetting();
                ((SystemSetting)null).SettingKey = "SettingHotline";
                ((SystemSetting)null).SettingValue = req.SettingHotline;
                db.SystemSettings.Add(null);
            }
            else
            {
            ...
            {
                set = new SystemSetting();
                ((SystemSetting)null).SettingKey = "SettingTitleSeo";
                ((SystemSetting)null).SettingValue = req.SettingTitleSeo;
                db.SystemSettings.Add(null);
            }
            else
            {
            ...
            {
                set = new SystemSetting();
                ((SystemSetting)null).SettingKey = "SettingDesSeo";
                ((SystemSetting)null).SettingValue = req.SettingDesSeo;
                db.SystemSettings.Add(null);
            }
            else
            {
            ...
            {
                set = new SystemSetting();
                ((SystemSetting)null).SettingKey = "SettingKeySeo";
                ((SystemSetting)null).SettingValue = req.SettingKeySeo;
                db.SystemSettings.Add(null);
            }
            else
            {
